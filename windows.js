...
var questions = [
  {
    questionText: ' Question 1: what are two issues with Windows',
    type: 'multi', // Type 'multi' indicates multi-choice question
    options: ['Driver issues', 'Display port issues', 'System crashes and freezes', 'Blue screens'],
    correctAnswers: ['Driver issues', 'System crashes and freezes']
  },
  {
    questionText: 'Question 2: what is the placeholder icon picture',
    type: 'single', // Type 'single' indicates single-choice question
    options: ['Bill Gates Mugshot', 'Steve Jobs', 'Linus Torvalds', 'Charles Babbage'],
    correctAnswer: 'Bill Gates Mugshot'
  },
  
  {
    questionText: 'Question 3: how much did Charles Simonyi pay to go the international space station',
    type: 'single', // Type 'single' indicates single-choice question
    options: ['30mil', '20mil', '900mil', '62mil'],
    correctAnswer: '30mil'
  },
];
