...
var questions = [
  {
    questionText: 'Question 1: what are two security issues with Wordpress?',
    type: 'multi', // Type 'multi' indicates multi-choice question
    options: ['The white screen of death', 'the pop up crash.','Exceeded maximum upload file size','timeing out '],
    correctAnswers: ['The white screen of death', 'Exceeded maximum upload file size']
  },
  {
    questionText: 'Question 2: what are two facts about Wordpress?',
    type: 'multi', // Type 'multi' indicates multi-choice question
    options: ['Wordpress is 19 years old','wordpress is owned by microsoft','the CEO of wordpress is Christine Selleck Tremoulet', 'WordPress has over 1.48B downloads'],
    correctAnswers: ['Wordpress is 19 years old', 'WordPress has over 1.48B downloads']
  },
  {
    questionText: 'Question 3:what is the market share percentage?',
